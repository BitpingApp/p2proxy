        ...
        match event {
            ...
            Events::Connection(connection_event) => {
                match connection_event {
                    ...
                    ConnectionEvents::Disconnected(_peer_id) => {
                        // Per-peer disconnect — decrement the
                        // connection counter rather than nuking it.
                        // The "connected/disconnected" status here
                        // is a coarse global indicator; the per-server
